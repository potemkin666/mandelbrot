...
> **Looking for the system reference?** See [`ARCHITECTURE.md`](https://github.com/potemkin666/mandelbrot/blob/main/ARCHITECTURE.md) for deployment topology, directory layout, caching layers, CI/CD, and contributor how-to guides.
